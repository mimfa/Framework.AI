...
{
    public class HierarchicalMaxmum : HierarchicalBase
    {
        public HierarchicalMaxmum(Func<double, double, double> distanceFunc = null) :base(distanceFunc)
        {
        }
        ...
        protected override double ComputeThreshould(double[][] matrix, int rowIndex, int colIndex)
        {
            ...
            return LastThreshould = matrix[rowIndex].Max();
        }
    }
}
