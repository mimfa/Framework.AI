...
{
    public class HierarchicalMode : HierarchicalBase
    {
        public HierarchicalMode(Func<double, double, double> distanceFunc = null) :base(distanceFunc)
        {
        }
        ...
        protected override double ComputeThreshould(double[][] matrix, int rowIndex, int colIndex)
        {
            ...
            return LastThreshould = MathService.Mode(matrix[rowIndex]);
        }
    }
}
